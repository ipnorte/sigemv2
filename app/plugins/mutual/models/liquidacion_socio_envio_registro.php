...
class LiquidacionSocioEnvioRegistro extends MutualAppModel{
	
	var $name = 'LiquidacionSocioEnvioRegistro';
	var $belongsTo = array('LiquidacionSocioEnvio','LiquidacionSocio');
