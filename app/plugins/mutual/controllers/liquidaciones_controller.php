...
//			}
		...
		if(!empty($this->data)){
            ...
            if(isset($this->data['LiquidacionIntercambio']['subdividir'])){
                ...
                $diskette = array();
                $diskette['banco_intercambio'] = $this->data['LiquidacionIntercambio']['banco_id'];
                $diskette['archivo'] = $this->data['LiquidacionIntercambio']['archivo']['name'];
                $diskette['info_cabecera'] = array();
                $diskette['info_pie'] = array();
                $registros = $this->leerArchivo($this->data['LiquidacionIntercambio']['archivo']['tmp_name']);

                #CREDICOOP
                if($this->data['LiquidacionIntercambio']['banco_id'] == '00191'){
                    ...
                    if(!empty($files)){
                        ...
                        foreach ($files as $idl => $cadena_1){
                            ...
                            $diskette_1['banco_intercambio'] = $this->data['LiquidacionIntercambio']['banco_id'];
                            $diskette_1['archivo'] = $idl."_".$this->data['LiquidacionIntercambio']['archivo']['name'];
                ...
                #BANCO GALICIA
                if($this->data['LiquidacionIntercambio']['banco_id'] == '00007'){
...
//                                $idl2 = intval(substr($campos['ref_univ'],7,5));
                ...
                if(in_array($this->data['LiquidacionIntercambio']['banco_id'], $BCRA_CODIGOS)){
...
//                             $diskette_1['pie'] = $diskette['pie']. "\r\n";
                ...
                #BANCO CORDOBA
                if($this->data['LiquidacionIntercambio']['banco_id'] == '00020'){
                    foreach($registros as $cadena) {
                ...
                # BANCO COMAFI
                #####################################################################
                if($this->data['LiquidacionIntercambio']['banco_id'] == '00299'){
                ...
                # BANCO DE COMERCIO
                ##################################################################################
                if($this->data['LiquidacionIntercambio']['banco_id'] == '00300'){
                    $diskette['cabecera'] =  array();
                    foreach($registros as $cadena){
                ...
                # ZENRISE
                ##################################################################################
				if($this->data['LiquidacionIntercambio']['banco_id'] == '99998'){
                    $diskette['cabecera'] =  array();
                    foreach($registros as $cadena){
                ...
                # BANCO ITAU 00259
                ##################################################################################
                if($this->data['LiquidacionIntercambio']['banco_id'] == '00259'){
...
//                    exit;
                ...
                # BANCO COINAG
                ##################################################################################
				if($this->data['LiquidacionIntercambio']['banco_id'] == '00431'){
                    $diskette['cabecera'] =  array_shift($registros);
                    $diskette['pie'] = array_pop($registros);
				...
				#BANCO CRONOCRED
				############################################################################
                if($this->data['LiquidacionIntercambio']['banco_id'] == '99950'){
