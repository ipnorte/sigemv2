...
<?php 
	if(MODULO_V1) echo "<h3>ORDENES DE COMPRAS</h3>";
	else echo "<h3>SOLICITUDES DE CONSUMO</h3>";
?>
...
<?php echo $this->renderElement('mutual_producto_solicitudes/grilla',array('solicitudes'=>$solicitudes,'edit' => true,'plugin' => 'mutual'))?>
<?php //echo $this->renderElement('paginado')?>
