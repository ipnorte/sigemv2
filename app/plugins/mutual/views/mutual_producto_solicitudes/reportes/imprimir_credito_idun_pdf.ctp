...
$PDF->Cell(48,$PDF->H,"COOP. PATAGONIA LTDA.",'RTB',0,'L',1);
...
$PDF->Cell(50,$PDF->H,"Firma y sello COOP. PATAGONIA LTDA.",'T',0,'C');
$PDF->Cell(20,$PDF->H,"");
...
$PDF->Cell(95,$PDF->H*2,"NO (  ) soy SUJETO OBLIGADO",'LBR',0,'C');
...
#######################################################################################
# SOLICITUD DE AFILIACION MUTUAL ISSAR
#######################################################################################
$PDF->AddPage();
$PDF->reset();
