...
$TEXTO_PIE = "La Pampa 1517 2°E - CP1428 - Cap. Fed. Buenos Aires - Tel. (5411) 4781-1220 - email: mserra@idun.com.ar";
...
function encabezado($PDF){
    ...
    $PDF->image(__DIR__ . DIRECTORY_SEPARATOR . "logotipo". DIRECTORY_SEPARATOR . "idun.png",5,5,60);   
    $PDF->image(__DIR__ . DIRECTORY_SEPARATOR . "logotipo". DIRECTORY_SEPARATOR . "IutumWordColor.jpg",170,5,30);
}
...
//$PDF->image(__DIR__ . DIRECTORY_SEPARATOR . "logotipo". DIRECTORY_SEPARATOR . "idun.png",5,5,50);
////$PDF->SetY(25);
...
$PDF->SetY(27);
$PDF->SetX(10);
$PDF->Cell(0,5,"SOLICITUD DE CREDITO",0,0,'C');
...
$PDF->Cell(42,$PDF->H,"ENTIDAD INTERMEDIA: ",'TB',0,'L',1);
$PDF->SetFont(PDF_FONT_NAME_MAIN,'B',$DEFAULT_FONT_SIZE);
$PDF->Cell(48,$PDF->H,"IUTUM",'RTB',0,'L',1);
...
$PDF->SetLinea(16);
//$PDF->Cell(190,$PDF->H,"Ingresos Mensuales",'LRTB');
...
$TEXTO .= "\n";
$TEXTO .= "Así mismo declaro conocer que al momento de la liquidación se me deducirán las sumas para cancelar los siguientes conceptos: Gastos Administrativos y Comerciales más IVA, sellados, impuestos y un Seguro de Vida (En caso de fallecimiento mis derechohabientes quedarán liberados de la obligación contraída con IDUN INVERSIONES S.A., una vez entregado a ésta el correspondiente Certificado de Defunción).-";
$TEXTO .= "\n";
...
$PDF->SetFont(PDF_FONT_NAME_MAIN,'B',$DEFAULT_FONT_SIZE);
$PDF->Cell(190,$PDF->H,"CONDICIONES GENERALES DE LA SOLICITUD DE CREDITO:",0,0,'L');
...
$TEXTO = "1.- A fin de documentar mi obligación, entregaré a IDUN INVERSIONES S.A. un pagaré a la vista sin protesto (de conformidad con el art. 50 Decreto Ley 5965/63) por el importe indicado como Monto Adeudado, comprometiéndome además a suscribir toda la documentación respectiva.";
$TEXTO .= "\n";
$TEXTO .= "2.- Incurriré en Mora, respecto al Préstamo solicitado si: a) Se comprobara falsedad o error de los datos que se consignan en esta Solicitud de Crédito. B) No abono cualquiera de las CUOTAS pactadas en el tiempo y forma acordados.";
$TEXTO .= "\n";
$TEXTO .= "3.- No será necesaria interpelación previa judicial o extrajudicial para la constitución de la Mora. La misma se producirá en forma automática de pleno derecho, producida la Mora, IDUN INVERSIONES S.A. podrá considerarla como de plazo vencido y exigir el inmediato pago del saldo adeudado con más los intereses compensatorios pactados y un interés punitorio equivalente al 50% del compensatorio. Los intereses correrán a partir de la mora y hasta tanto IDUN INVERSIONES S.A. pueda disponer del monto adeudado. Los intereses compensatorios y moratorios se capitalizarán cada 30 días (art. 623 del Código Civil)";
$TEXTO .= "\n";
$TEXTO .= "4.- El mutuo se considerará perfeccionado con la entrega al solicitante de la suma peticionada y/o en el supuesto del cumplimiento con lo establecido en la cláusula 14 del presente.";
$TEXTO .= "\n";
$TEXTO .= "5.- En caso de que por cualquier causa no pudiere descontar de mis haberes total o parcialmente las CUOTAS pactadas y/o las diferencias, me comprometo a cancelar las mismas del 5 al 10 de cada mes en la Tesorería de IDUN INVERSIONES S.A. en su domicilio de Gorostiaga no 1664 – Primer Piso – Oficina “B” de la Ciudad Autónoma de Buenos Aires (C.P. 1.426).";
$TEXTO .= "\n";
$TEXTO .= "6.- En caso de desear cancelar en forma anticipada el crédito solicitado en la presente, me notifico que lo podré realizar solamente cuando el mismo se encuentre con la mitad más una de sus cuotas canceladas. Para el caso de que efectúe la cancelación total de la deuda, deberé abonar el hasta 15 en concepto de gastos administrativos sobre el saldo deudor.";
$TEXTO .= "\n";
$TEXTO .= "7.- La omisión o demora por parte de IDUN INVERSIONES S.A. en el ejercicio de cualquier derecho o privilegio emergente de esta solicitud no podrá en ningún caso considerarse como una renuncia al mismo, así como su ejercicio parcial no impedirá implementarlo posteriormente ni enervará el ejercicio de cualquier otro derecho o privilegio.";
$TEXTO .= "\n";
$TEXTO .= "8.- En caso de cualquier defecto y/o perjuicio que me fuera ocasionado en virtud de la prestación de los servicios solicitados en este acto a IDUN INVERSIONES S.A., acepto en forma expresa que en el caso de ser prestados dichos servicios por terceros prestadores, IDUN INVERSIONES S.A. no será responsable en forma alguna de los daños y perjuicios que la prestación de tales servicios pudiera ocasionarme, siendo dicha responsabilidad exclusiva y excluyente del tercer prestador de tal servicio. En tal sentido renuncio en forma expresa y con la mayor amplitud a formular reclamos de cualquier índole a IDUN INVERSIONES S.A. por los hechos o circunstancias señaladas en el presente apartado.";
$TEXTO .= "\n";
...
$TEXTO = "A la vista pagaré sin protesto (artículo 50 decreto ley 5965/63), a IDUN INVERSIONES S.A. o a su orden, la cantidad de pesos ".$orden['MutualProductoSolicitud']['total_letras']." ($ ".$orden['MutualProductoSolicitud']['importe_total']."), por igual valor recibido en efectivo a mi entera satisfacción, pagadero en la misma moneda.";
$TEXTO .= "\n";
...
$TXT_PAGARE = "El ____ de __________ de ______ PAGARE SIN PROTESTO (Art. 50 Decreto ";
...
$TXT_PAGARE .= "en efectivo a mi entera satisfacción, pagadero en ____________________________.-\n";
...
$TEXTO = "Solicito por la presente que el neto del Crédito solicitado a través de \"COOP. DE VIVIENDA, CREDITO Y CONSUMO PATAGONIA Ltda.\" por el suscripto, me sea abonado de la siguiente manera:";
$TEXTO .= "\n";
$TEXTO .= "\n";
...
if(!isset($orden['MutualProductoSolicitudInstruccionPago']) || empty($orden['MutualProductoSolicitudInstruccionPago'])){
    ...
    $TEXTO .= "\n";
    $TEXTO .= "c) Al momento de liquidar el Crédito autorizo a IDUN INVERSIONES S.A. a retener el monto suficiente para la cancelación de los gastos de comisiones, sellado, seguros de vida y desempleo, administración e impuestos.-";
    ...
    foreach($orden['MutualProductoSolicitudInstruccionPago'] as $instruccion):
            ...
            $n++;
    endforeach;
    $TEXTO .= "$n) Al momento de liquidar el Crédito autorizo a IDUN INVERSIONES S.A. a retener el monto suficiente para la cancelación de los gastos de comisiones, sellado, seguros de vida y desempleo, administración e impuestos.-";
}
...
$PDF->SetLinea(19);
$PDF->SetFont(PDF_FONT_NAME_MAIN,'',$DEFAULT_FONT_SIZE);
$TEXTO = "Recibo de conformidad en este acto, la Liquidación Neta de Fondos a mi orden del Crédito solicitado, abonado por IDUN INVERSIONES S.A. en cheque, o a través de depósito o giro o transferencia bancaria (marcar opción elegida).-";
$TEXTO .= "\n";
...
//        $PDF->image(WWW_ROOT . DIRECTORY_SEPARATOR . "img" . DIRECTORY_SEPARATOR . "logos". DIRECTORY_SEPARATOR . "LogoAmupap.jpg",10,5,40);
