...
1. Solicitud
2. Hoja Blanca
3. Mutuo Completo parte1
4. Mutuo Completo parte2
5. Ficha
6. Hoja Blanca
7. Mutuo Incompleto parte1
8. Mutuo Incompleto parte2
9. Pagaré
10. Hoja Blanca
11. Croquis 
12. Hoja Blanca
13. Autorización débito
14. Hoja Blanca
15. Recibo
16. Hoja Blanca
17. Liquidación de Préstamo
 * 
 * */
...
if(!empty($orden['MutualProductoSolicitud']['detalle_calculo_plan'])){
    ...
    $PDF->ocom_imprime_mutuo_ryvsa($orden,$TEXTO);
}
...
#############################################################################################
$PDF->hojaEnBlanco();
$PDF->autorizacionCobranzaDebitoDirectoGeneral($orden, NULL, 'ASOCIACION MUTUAL SAN COSME');
...
///////////////////////////////////////////////////////////////// 
// SOLICITUD AFILIACION MUTUAL SAN COSME
///////////////////////////////////////////////////////////////// 
$PDF->hojaEnBlanco();

$PDF->SetFont(PDF_FONT_NAME_MAIN,'B',14);
$PDF->Cell(0,5,'Asociación Mutual SAN COSME',0);
$PDF->Ln(5);
$PDF->SetFont(PDF_FONT_NAME_MAIN,'',8);
$PDF->Cell(0,5,'Sucre 225- TE. 0351-5684740',0);
$PDF->SetY(25);
...
$TEXTO = "Señores Miembros del Consejo Directivo de la Asociación. Mutual San Cosme.: ";
$TEXTO .= "\n";
$TEXTO .= "Por la presente me dirijo a Uds., a los efectos de solicitarles mi inscripción como socio/a de la Asociación Mutual SAN COSME, de acuerdo a los estipulado en el Estatuto Social de la entidad en calidad de socio adherente, para la cual, adjunto los datos que a continuación se detallan:";
$TEXTO .= "\n";
$PDF->MultiCell(0,11,$TEXTO);
$PDF->ln(4);
$PDF->imprimirDatosTitular($orden, false);
$PDF->ln(4);
$size = 13;
$PDF->linea[1] = array(
		'posx' => 10,
		'ancho' => 190,
		'texto' => "AUTORIZACION DE DEBITO EN CAJA DE AHORRO",
		'borde' => '',
		'align' => 'C',
		'fondo' => 0,
		'style' => 'B',
...
$PDF->linea[1] = array(
		'posx' => 10,
		'ancho' => 190,
		'texto' => "DEL BANCO " . utf8_decode($orden['MutualProductoSolicitud']['beneficio_banco']),
		'borde' => '',
		'align' => 'C',
		'fondo' => 0,
		'style' => 'B',
...
$PDF->ln(3);
$PDF->SetFont(PDF_FONT_NAME_MAIN,'',12);
$TEXTO = "Por la presente faculto irrevocablemente al Banco " . utf8_decode($orden['MutualProductoSolicitud']['beneficio_banco']) . " a debitar sin previo aviso, de mi Caja de Ahorro CBU Nº " . utf8_decode($orden['MutualProductoSolicitud']['beneficio_cbu']) . " o en las cuentas y sucursales que en el futuro mi empleador deposite mis haberes mensuales hasta cubrir la suma de la cuota social e intereses que devenguen el incumplimiento de las condiciones pautadas bajo la condición de abonar con estos fondos los costos de capacitación y/u otros servicios que además tengan fondos acreditados en dichas cuentas, los importes informados por la Asociación Mutual SAN COSME, a la que por separado he autorizado a debitar de dicha cuenta, originados en negocios jurídicos, convenidos por mi con la Asociación Mutual SAN COSME. Me obligo a disponer de fondos suficientes, al momento que los débitos se realicen.";
$TEXTO .= "\n";
$TEXTO .= "Asimismo, autorizo a la Asociación Mutual SAN COSME, o a la Caja de Jubilaciones de la Provincia, a descontar de mis haberes mensuales, a través de los códigos que correspondan, los montos equivalentes a la cuota social y consumo (en forma mensual y consecutiva), como así también los que generen los Fondos de Asistencia, seguros, y todo otro consumo o gasto que surja de los comprobantes pertinentes o gastos por mora.";
$TEXTO .= "\n";
$TEXTO .= "Declaro bajo juramento que estos datos consignados en la presente solicitud son auténticos, como comprometiéndome en la Asociación Mutual SAN COSME, todo cambio que se produzca, dentro de las 72 horas de acontecido el mismo, adjuntando para ello la documentación que la entidad me solicite a tal efecto.-";
$TEXTO .= "\n";
$TEXTO .= "En el caso de querer dejar de percibir el beneficio deberá hacerlo personalmente en nuestras oficinas a través del formulario correspondiente de baja. ";
$TEXTO .= "A los " . $orden['MutualProductoSolicitud']['fecha_emision_str']['dia']['numero']. " días del mes de ".$orden['MutualProductoSolicitud']['fecha_emision_str']['mes']['string']." del año " . $orden['MutualProductoSolicitud']['fecha_emision_str']['anio']['numero']. ".-----";
$TEXTO .= "\n";
$PDF->MultiCell(0,11,$TEXTO);
$PDF->ln(25);
$PDF->firmaSocio();
...
if(isset($orden['MutualProductoSolicitud']['proveedor_plan_anexos']) && !empty($orden['MutualProductoSolicitud']['proveedor_plan_anexos'])){
    ...
    foreach($orden['MutualProductoSolicitud']['proveedor_plan_anexos'] as $anexo){
        ...
        if($anexo == "ocom_modelo2_liquidacion"){
            $PDF->hojaEnBlanco();
            $PDF->imprime_modelo2_liquidacion_cuotas($orden);
        }
