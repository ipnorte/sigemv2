...
$PDF->AddPage();
$PDF->reset();
$PDF->imprimirPagare($orden,false,false,false,false);
...
function imprimeCBASERVICIOS($orden, $PDF) {
...
Undécima: El deudor declara bajo juramento que el destino de los fondos otorgados por ________________________ será: Consumo---------------------------------------.
EOD;
    ...
    $PDF->linea[1] = array(
        'posx' => 10,
        'ancho' => 190,
        'texto' => utf8_decode("________________, ". $orden['MutualProductoSolicitud']['fecha_emision_str']['dia']['numero'] . " de " . $orden['MutualProductoSolicitud']['fecha_emision_str']['mes']['string']. " de " . $orden['MutualProductoSolicitud']['fecha_emision_str']['anio']['numero'] . ".-"),
        'borde' => '',
        'align' => 'R',
        'fondo' => 0,
        'style' => '',
    ...
    $TEXTO = "________________________________\n\nDe mi mayor consideración:\n".
              "En mi carácter de Titular del Préstamo Nº ".$orden['MutualProductoSolicitud']['nro_print'].", me dirijo a Uds. a fin de autorizar y prestar mi entera ".
              "conformidad en forma irrevocable a descontar de mis haberes por débito automático de la Caja de Ahorro / Cta. ".
              "Cte. (tachar lo que no corresponda) Nº  ".$orden['MutualProductoSolicitud']['beneficio_cuenta']." que poseo radicada en el Banco ".$orden['MutualProductoSolicitud']['beneficio_banco']." ".
              "Sucursal ".$orden['MutualProductoSolicitud']['beneficio_sucursal'].", ".
              "correspondiente a la Clave Bancaria Uniforme (C.B.U.) ".$orden['MutualProductoSolicitud']['beneficio_cbu']."  o ".
              ...
              "abonar la suma de $ ".number_format($orden['MutualProductoSolicitud']['importe_total'],2)." (Pesos ".utf8_decode($orden['MutualProductoSolicitud']['total_letras']).") ".
              "durante ".$orden['MutualProductoSolicitud']['cantidad_cuota_letras']." (".$orden['MutualProductoSolicitud']['cuotas'].") períodos mensuales, iguales y consecutivos a ".
              ...
              "Administrador a los ﬁnes de procesamiento de los descuentos que le fueran remitidos por ________________________ ".
...
$TEXTO = "Por la presente, quien suscribe, ".utf8_decode($orden['MutualProductoSolicitud']['beneficiario_apenom']).", en ".
         ...
         "".$orden['MutualProductoSolicitud']['beneficio_cuenta'].", radicada en el Banco ".$orden['MutualProductoSolicitud']['beneficio_banco'].", ".
         "Sucursal ".$orden['MutualProductoSolicitud']['beneficio_sucursal'].", CBU Nº ".$orden['MutualProductoSolicitud']['beneficio_cbu']." presto ".
         "autorización en forma expresa e irrevocable a ________________________ a debitar ".
         "de dicha cuenta la suma total de pesos ".utf8_decode($orden['MutualProductoSolicitud']['total_letras'])." ".
         "($ ".number_format($orden['MutualProductoSolicitud']['importe_total'],2)."), en ".$orden['MutualProductoSolicitud']['cantidad_cuota_letras']." (".$orden['MutualProductoSolicitud']['cuotas'].") cuotas iguales, mensuales y ".
         "consecutivas de pesos ".$orden['MutualProductoSolicitud']['total_cuota_letras']." ($ ".number_format($orden['MutualProductoSolicitud']['importe_cuota'],2).") ".
         ...
         "un importe mayor a $750 y subsanaren la forma de facturación directa.\n";
