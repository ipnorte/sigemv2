...
$PDF->linea[1] = array(
		'posx' => 10,
		'ancho' => 190,
		'texto' => utf8_decode("Córdoba, _____ de __________________ de ________"),
		'borde' => '',
		'align' => 'R',
		'fondo' => 0,
		'style' => '',
...
$PDF->ln(5);
$PDF->SetFontSizeConf($size);
$PDF->MultiCell(0,20,$TXT_PAGARE,0,'J',0,2);
...
if(isset($orden['MutualProductoSolicitud']['proveedor_plan_anexos']) && !empty($orden['MutualProductoSolicitud']['proveedor_plan_anexos'])){
    ...
    foreach($orden['MutualProductoSolicitud']['proveedor_plan_anexos'] as $anexo){
		...
		if($anexo == "ocom_modelo2_liquidacion") $PDF->imprime_modelo2_liquidacion_cuotas($orden);
