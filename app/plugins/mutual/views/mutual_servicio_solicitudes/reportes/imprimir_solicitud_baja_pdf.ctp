...
$PDF->SetTitle("SOLICITUD DE BAJA DE SERVICIO #".$id);
$PDF->SetFontSizeConf(8.5);

$PDF->Open();

#TITULO DEL REPORTE#
$PDF->titulo['titulo3'] = "SOLICITUD DE BAJA DE SERVICIO";
$PDF->titulo['titulo2'] = ""; //"FECHA ALTA SERVICIO: ". $util->armaFecha($solicitud['MutualServicioSolicitud']['fecha_alta_servicio']);
$PDF->titulo['titulo1'] = "FECHA EMISION: " .$util->armaFecha($solicitud['MutualServicioSolicitud']['fecha_emision_baja']);
...
//	$PDF->Ln(3);
	...
	$PDF->linea[1] = array(
				'posx' => 10,
				'ancho' => 20,
				'texto' => "DETALLE DE LAS PERSONAS DADAS DE BAJA",
				'borde' => '',
				'align' => 'L',
				'fondo' => 0,
				'style' => 'B',
	...
	$PDF->linea[1] = array(
			'posx' => 10,
			'ancho' => 20,
			'texto' => $solicitud['MutualServicioSolicitud']['titular_tdocndoc'],
			'borde' => 'L',
			'align' => 'L',
			'fondo' => 0,
			'style' => '',
	...
	$PDF->linea[2] = array(
			'posx' => 30,
			'ancho' => 50,
			'texto' => $solicitud['MutualServicioSolicitud']['titular_apenom'],
			'borde' => '',
			'align' => 'L',
			'fondo' => 0,
			'style' => '',
	...
	$PDF->linea[5] = array(
			'posx' => 170,
			'ancho' => 30,
			'texto' => $util->armaFecha($solicitud['MutualServicioSolicitud']['fecha_baja_servicio']),
			'borde' => 'R',
			'align' => 'C',
			'fondo' => 0,
			'style' => 'B',
