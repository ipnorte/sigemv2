...
<?php echo $this->renderElement('head',array('title' => 'REPROCESAMIENTO DISKETTE BANCOS'))?>
...
<div class="areaDatoForm">
	...
	<?php echo $frm->create(null,array('action'=>'reprocesar_archivo/'.$archivo['LiquidacionIntercambio']['id'],'id' => 'formReproArchivo'))?>
...
<?php if(!empty($datos) && !$resumenByTurno):?>
	...
	<?php echo $this->renderElement("banco/info_diskette",array('plugin' => 'config', 'uuid' => $diskette_uuid, 'listado' => '/mutual/liquidacion_socios/reprocesar_archivo/' . $intercambioId))?>
