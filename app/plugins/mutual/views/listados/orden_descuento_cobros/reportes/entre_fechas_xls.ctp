...
$oPHPExcel->getActiveSheet()->setTitle('COBRADO');
$offSet = 5;
...
$oPHPExcel->getActiveSheet()->setCellValue('A1','TIPO COBRO:');
$oPHPExcel->getActiveSheet()->setCellValue('B1',$util->globalDato($asinc['Asincrono']['p1']));

$oPHPExcel->getActiveSheet()->setCellValue('A2','DESDE / HASTA FECHA');
$oPHPExcel->getActiveSheet()->setCellValue('B2',$util->armaFecha($asinc['Asincrono']['p2']) . " / " . $util->armaFecha($asinc['Asincrono']['p3']));

$oPHPExcel->getActiveSheet()->setCellValue('A3','PROVEEDOR:');
$oPHPExcel->getActiveSheet()->setCellValue('B3',$proveedor);	
