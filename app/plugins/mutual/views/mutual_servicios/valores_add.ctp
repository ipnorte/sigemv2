...
<h3><?php echo $util->globalDato($servicio['MutualServicio']['tipo_producto'])?> :: NUEVO VALOR DE TARIFA</h3>
...
function validateForm(){
	...
	//}
	if(impoAdicional == 0){
		return confirm("EL IMPORTE DE LA CUOTA MENSUAL PARA EL ADICIONAL ES CERO.\nES CORRECTO?");
	}	
	return true;
