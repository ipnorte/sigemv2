<?php 
$orden = $this->requestAction('/mutual/orden_descuentos/get_orden/' . $id);
$detallaCuotas = (isset($detallaCuotas) ? $detallaCuotas : true);
$detalle = (isset($detalle) ? $detalle : true);
?>
...
<div class="areaDatoForm3">
	...
	<div class="areaDatoForm2">
		...
		(LIQUIDAR HASTA <strong><?php echo $util->periodo($orden['OrdenDescuento']['periodo_hasta'],true)?></strong>)
		<?php endif;?>
	</div>
	<?php endif;?>
...
<?php if(!empty($orden['OrdenDescuento']['observaciones']) && trim($orden['OrdenDescuento']['observaciones']) != ''):?>
...
<?php if($detallaCuotas==1 && $orden['OrdenDescuento']['nueva_orden_descuento_id'] == 0):?>
		<div class="areaDatoForm3">
