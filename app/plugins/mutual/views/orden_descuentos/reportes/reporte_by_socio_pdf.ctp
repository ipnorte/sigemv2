...
#TITULO DEL REPORTE#
$PDF->titulo['titulo3'] = 'ORDENES DE DESCUENTO DEL SOCIO';
...
foreach($ordenes as $orden){
	...
	$PDF->linea[0] = array(
		...
		$PDF->linea[4] = array(
					'posx' => $L1[4],
					'ancho' => $W1[4],
					'texto' => number_format($orden['OrdenDescuento']['importe_devengado'],2) ."(".$orden['OrdenDescuento']['cuotas'].")",
					'borde' => '',
					'align' => 'R',
					'fondo' => 0,
					'style' => '',
		...
		$PDF->linea[5] = array(
					'posx' => $L1[5],
					'ancho' => $W1[5],
					'texto' => number_format($orden['OrdenDescuento']['importe_vencido'],2)."(".$orden['OrdenDescuento']['vencidas'].")",
					'borde' => '',
					'align' => 'R',
					'fondo' => 0,
					'style' => '',
		...
		$PDF->linea[6] = array(
					'posx' => $L1[6],
					'ancho' => $W1[6],
					'texto' => number_format($orden['OrdenDescuento']['importe_avencer'],2)."(".$orden['OrdenDescuento']['avencer'].")",
					'borde' => '',
					'align' => 'R',
					'fondo' => 0,
					'style' => '',
		...
		$PDF->linea[7] = array(
					'posx' => $L1[7],
					'ancho' => $W1[7],
					'texto' => number_format($orden['OrdenDescuento']['importe_pagado'],2)."(".$orden['OrdenDescuento']['pagadas'].")",
					'borde' => '',
					'align' => 'R',
					'fondo' => 0,
					'style' => '',
...
$PDF->linea[4] = array(
			'posx' => $L1[4],
			'ancho' => $W1[4],
			'texto' => number_format($ACUM_DEVENGADO,2),
			'borde' => '',
			'align' => 'R',
			'fondo' => 1,
			'style' => 'B',
...
$PDF->linea[5] = array(
			'posx' => $L1[5],
			'ancho' => $W1[5],
			'texto' => number_format($ACUM_VENCIDO,2),
			'borde' => '',
			'align' => 'R',
			'fondo' => 1,
			'style' => 'B',
...
$PDF->linea[6] = array(
			'posx' => $L1[6],
			'ancho' => $W1[6],
			'texto' => number_format($ACUM_AVENCER,2),
			'borde' => '',
			'align' => 'R',
			'fondo' => 1,
			'style' => 'B',
...
$PDF->linea[7] = array(
			'posx' => $L1[7],
			'ancho' => $W1[7],
			'texto' => number_format($ACUM_PAGADO,2),
			'borde' => '',
			'align' => 'R',
			'fondo' => 1,
			'style' => 'B',
