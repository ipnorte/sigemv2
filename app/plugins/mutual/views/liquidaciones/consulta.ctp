...
//					echo $html->image('controles/lock_unlock.png');
			...
			<td align="center"><?php echo $controles->botonGenerico('/mutual/liquidaciones/reporte_proveedores/'.$liquidacion['Liquidacion']['id'].($liquidacion['Liquidacion']['imputada'] == 0 ? '/1/0/1' : ''),'controles/book.png')?></td>
