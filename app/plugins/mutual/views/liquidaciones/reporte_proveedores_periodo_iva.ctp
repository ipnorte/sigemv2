...
<?php //   if(!empty($liquidacion)) echo $this->renderElement('liquidacion/info_cabecera_liquidacion',array('liquidacion'=>$liquidacion,'plugin'=>'mutual'))?>

<h3>REPORTE LIQUIDACION PROVEEDORES <?php echo $util->periodo($periodo)?></h3>
...
echo $this->renderElement('show',array(
										'plugin' => 'shells',
										'process' => 'reporte_control_liquidacion_periodo',
										'accion' => '.mutual.liquidaciones.reporte_proveedores.0.1.0.0.'. $periodo,
										'target' => '',
...
//	endif;
	...
	$tabs[4] = array('url' => '/mutual/listados/reporte_imputacion_deuda/0/'.$PID.'/PDF/' . $procesarSobrePreImputacion . '/' . $periodo,'label' => 'IMPRIMIR PLANILLA', 'icon' => 'controles/pdf.png','atributos' => array('target' => 'blank'), 'confirm' => null);
	$tabs[5] = array('url' => '/mutual/listados/reporte_imputacion_deuda/0/'.$PID.'/XLS/' . $procesarSobrePreImputacion . '/' . $periodo,'label' => 'EXPORTAR PLANILLA', 'icon' => 'controles/ms_excel.png','atributos' => array('target' => 'blank'), 'confirm' => null);
	...
	<table class="tbl_grilla">
		...
		<tr>
			<th colspan="18" style="text-align: left;">PROVEEDOR</th>
		</tr>
		...
		<tr>
			...
			<th colspan="3">COMISION COBRANZA</th>
		...
		<?php foreach($proveedores as $dato):?>
			...
			<?php if($PROVEEDOR != trim($dato['entero_1'])):?>
				...
				<tr>
					<td colspan="15" style="font-size:13px;background-color: #e2e6ea"><strong><?php echo $dato['texto_1']?></strong></td>
			...
			<?php $TIVA += $dato['decimal_15'];?>
			<tr>
			
				<td></td>
                <td style="white-space: nowrap;"><strong><?php echo $dato['texto_4']?></strong> - <?php echo $dato['texto_5']?></td>
                ...
                <td align="right"><?php echo $util->nf(($dato['texto_2'] != 'REVERSADO' ? $dato['decimal_15'] : $dato['decimal_15'] * -1))?></td>
