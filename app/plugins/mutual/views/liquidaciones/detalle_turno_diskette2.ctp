...
<?php if(!empty($socios)):?>
	...
	<table>
            <tr>
                <td style="text-align: left;">
                            <input type="button" onclick="javascript:window.location='<?php echo $this->base?>/mutual/liquidaciones/detalle_turno_diskette/<?php echo $liquidacion['Liquidacion']['id'].'/'.$turno.'/SOCIO/NOENVIAR_ALL'?>'" value="QUITAR TODOS"/>
                            <input type="button" onclick="javascript:window.location='<?php echo $this->base?>/mutual/liquidaciones/detalle_turno_diskette/<?php echo $liquidacion['Liquidacion']['id'].'/'.$turno.'/SOCIO/ENVIAR_ALL'?>'" value="ENVIAR TODOS"/>
		...
		<?php foreach($socios as $socio):?>
                ...
                <tr id="TRL_<?php echo $i?>" class="<?php echo ($socio['LiquidacionSocio']['diskette'] == 1 ? "activo_1" : "activo_0")?>">
	...
	<?php echo $frm->hidden('LiquidacionSocio.turno_pago',array('value' => $turno))?>
        <?php echo $frm->hidden('LiquidacionSocio.action')?>
