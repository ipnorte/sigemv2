...
$PDF->SetTitle("Resumen Cruce de Información de Liquidacion ANSES - " . $util->periodo($liquidacion['Liquidacion']['periodo'],true));
...
$PDF->Output("resumen_cruce_liquidacion_deuda_anses_".$liquidacion['Liquidacion']['periodo'].".pdf");
