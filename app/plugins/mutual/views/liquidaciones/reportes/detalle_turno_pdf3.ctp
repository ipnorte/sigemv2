...
foreach($socios as $socio):
    ...
    $ACUM_SALDO += $socio['LiquidacionSocioNoimputada']['saldo_actual'];
    $ACUM_REG  += $socio['LiquidacionSocioNoimputada']['registro'];
...
function imprimirRenglon($PDF,$L1,$W1,$socio){
    ...
    $PDF->linea[0] = array(
        'posx' => $L1[0],
        'ancho' => $W1[0],
        'texto' => substr($socio['LiquidacionSocioNoimputada']['documento'] ." - ". $socio['LiquidacionSocioNoimputada']['apenom'],0,35),
        'borde' => '',
        'align' => 'L',
        'fondo' => 0,
        'style' => '',
    ...
    $PDF->linea[2] = array(
        'posx' => $L1[2],
        'ancho' => $W1[2],
        'texto' => substr($socio['LiquidacionSocioNoimputada']['banco'],0,33),
        'borde' => '',
        'align' => 'L',
        'fondo' => 0,
        'style' => '',
    ...
    $PDF->linea[5] = array(
        'posx' => $L1[5],
        'ancho' => $W1[5],
        'texto' => number_format($socio['LiquidacionSocioNoimputada']['saldo_actual'],2),
        'borde' => '',
        'align' => 'R',
        'fondo' => 0,
        'style' => '',
    ...
    $PDF->linea[6] = array(
        'posx' => $L1[6],
        'ancho' => $W1[6],
        'texto' => number_format($socio['LiquidacionSocioNoimputada']['importe_adebitar'],2),
        'borde' => '',
        'align' => 'R',
        'fondo' => 0,
        'style' => '',
