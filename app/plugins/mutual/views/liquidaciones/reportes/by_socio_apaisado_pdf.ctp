...
$Wc = array(20,25,25,20,52,10,45,20,20,20,20);
...
$Wd1 = array(25,107,15,50,10,30,20,20);
...
$Wd2 = array(15,55,147,20,20,20);
$Ld2 = $PDF->armaAnchoColumnas($Wd2);


$fontSize_titulo = 10;
$fontSize_subtablas = 7;
...
foreach($liquidaciones as $periodo => $detalle):
	...
	$PDF->linea[0] = array(
				'posx' => $L1[0],
				'ancho' => 277,
				'texto' => 'PERIODO '.$util->periodo($periodo,true) . (!empty($detalle['status']) ? " " . $detalle['status'] : ""),
				'borde' => 'LTBR',
				'align' => 'L',
				'fondo' => 1,
				'style' => 'B',
	...
	foreach($detalle['cuotas'] as $cuota):
		...
		$PDF->linea[1] = array(
					'posx' => $Lc[1],
					'ancho' => $Wc[1],
					'texto' => substr($cuota['Organismo']['concepto_1'],0,16),
					'borde' => '',
					'align' => 'L',
					'fondo' => 0,
					'style' => '',
		...
		$PDF->linea[4] = array(
					'posx' => $Lc[4],
					'ancho' => $Wc[4],
					'texto' => substr($cuota[0]['proveedor_producto'],0,35),
					'borde' => '',
					'align' => 'L',
					'fondo' => 0,
					'style' => '',
		...
		$PDF->linea[5] = array(
					'posx' => $Lc[5],
					'ancho' => $Wc[5],
					'texto' => ($cuota['OrdenDescuento']['permanente'] ? '00/00' : $cuota[0]['cuota']),
					'borde' => '',
					'align' => 'C',
					'fondo' => 0,
					'style' => '',
		...
		$PDF->linea[6] = array(
					'posx' => $Lc[6],
					'ancho' => $Wc[6],
					'texto' => $cuota['TipoCuota']['concepto_1'],
					'borde' => '',
					'align' => 'L',
					'fondo' => 0,
					'style' => '',
...
//	$TOTAL_ADICIONAL_DEBITADO = round($TOTAL_ADICIONAL_DEBITADO,2);
	...
	foreach($detalle['cabecera_liquidacion'] as $liquidacion):
		...
		$PDF->linea[0] = array(
					'posx' => $Ld[0],
					'ancho' => $Wd[0],
					'texto' => substr($util->globalDato($liquidacion['LiquidacionSocio']['codigo_organismo']),0,16),
					'borde' => '',
					'align' => 'L',
					'fondo' => 0,
					'style' => '',
	...
	if(!empty($detalle['rendicion'])):
		...
		foreach($detalle['rendicion'] as $rendicion):
			...
			$PDF->linea[0] = array(
						'posx' => $Ld1[0],
						'ancho' => $Wd1[0],
						'texto' => substr($rendicion['LiquidacionSocioRendicion']['organismo'],0,16),
						'borde' => '',
						'align' => 'L',
						'fondo' => 0,
						'style' => '',
	...
	if(!empty($detalle['reintegros'])):
		...
		foreach($detalle['reintegros'] as $reintegro):
			...
			$PDF->linea[1] = array(
						'posx' => $Ld2[1],
						'ancho' => $Wd2[1],
						'texto' => $reintegro['SocioReintegro']['liquidacion_str'] . ($reintegro['SocioReintegro']['anticipado'] == 1 ? " ** ANTICIPADO **" : " ** COMUN **"),
						'borde' => '',
						'align' => 'L',
						'fondo' => 0,
						'style' => '',
