...
//	endif;
	...
	$tabs[4] = array('url' => '/mutual/listados/reporte_imputacion_deuda/0/'.$PID.'/PDF/' . 2 . '/' . $periodo,'label' => 'IMPRIMIR PLANILLA', 'icon' => 'controles/pdf.png','atributos' => array('target' => 'blank'), 'confirm' => null);
	$tabs[5] = array('url' => '/mutual/listados/reporte_imputacion_deuda/0/'.$PID.'/XLS/' . 2 . '/' . $periodo,'label' => 'EXPORTAR PLANILLA', 'icon' => 'controles/ms_excel.png','atributos' => array('target' => 'blank'), 'confirm' => null);
		...
		<?php foreach($proveedores as $dato):?>
			...
			<?php if($PROVEEDOR != trim($dato['entero_1'])):?>
				...
				<tr>
					...
					<td style="font-size:13px;background-color: #e2e6ea"><?php echo $controles->botonGenerico('/mutual/listados/reporte_proveedores/0/'.$dato['entero_1'].'/0/0/XLS/' . $procesarSobrePreImputacion.'/'.$periodo,'controles/ms_excel.png','',array('target' => '_blank'))?></td>
