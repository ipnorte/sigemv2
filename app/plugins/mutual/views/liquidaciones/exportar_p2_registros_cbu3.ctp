...
<?php if(!empty($sociosByTurno)):?>
	...
	<?php echo $this->renderElement("banco/info_diskette",array('plugin' => 'config','toPDF' => TRUE, 'toXLS' => TRUE, 'uuid' => $DISKETTE_UUID, 'listado' => '/mutual/liquidaciones/diskette_cbu_pdf3/' . $liquidacion['Liquidacion']['id'] . "/1"))?>
