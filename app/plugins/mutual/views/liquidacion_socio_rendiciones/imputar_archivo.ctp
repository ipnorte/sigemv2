...
<h3>IMPUTAR ARCHIVO EN CUENTA DE SOCIOS</h3>
...
<?php if(empty($LqdInterCambio['LiquidacionIntercambio']['recibo_id'])):?>
...
<div class="areaDatoForm">
<?php echo $frm->create(null,array('name'=>'formReciboCobro','id'=>'formReciboCobro','onsubmit' => "return ctrlCobro()", 'action' => "imputar_archivo/" . $LqdInterCambio['LiquidacionIntercambio']['id'] . '/' . $LqdInterCambio['LiquidacionIntercambio']['liquidacion_id'] ));?>
	...
	<?php echo $frm->btnGuardarCancelar(array('TXT_GUARDAR' => 'GUARDAR E IMPUTAR LOTE','URL' => '/mutual/liquidaciones/importar/' . $LqdInterCambio['LiquidacionIntercambio']['liquidacion_id']))?>
...
<?php elseif($LqdInterCambio['LiquidacionIntercambio']['imputada'] == 0):?>

<div id="processAsincContainer" class="areaDatoForm3">
    <h4>PROCESO DE IMPUTACION DE ARCHIVO</h4>
</div>
