<?php echo $this->renderElement('head',array('plugin' => 'config','title' => 'CONFIGURACION DE CUENTAS BANCARIAS :: ALTA NUEVA CUENTA'))?>
<?php echo $frm->create('BancoCuenta');?>
<div class="areaDatoForm">
	<table class="tbl_form">
		<tr>
			<td>BANCO</td><td><?php echo $this->renderElement('banco/combo_global',array('plugin' => 'config','tipo' => 4, 'model' => 'BancoCuenta.banco_id', 'selected' => (isset($this->data['BancoCuenta']['banco_id']) ? $this->data['BancoCuenta']['banco_id'] : "")))?></td>
		</tr>
		<tr>
			<td>DENOMINACION DE LA CUENTA</td><td><?php echo $frm->input('denominacion',array('size' => 60, 'maxlength' => 100))?></td>
		</tr>
		<tr>
			<td>NRO. DE CUENTA</td><td><?php echo $frm->input('numero',array('size' => 20, 'maxlength' => 20))?></td>
		</tr>
		<tr>
