...
if($dias > 1):
//	$W1 = array(46, 47, 46, 46, 46, 46);
	$W1 = array(30, 81, 30, 30, 30, 76);
else:
//	$W1 = array(55, 57, 55, 55, 55);
	$W1 = array(102, 30, 30, 30, 85);
endif;
...
$PDF->encabezado[0][$i] = array(
	...
	foreach ($temporal as $renglon):
		...
		$PDF->linea[$i] = array(
					'posx' => $L1[$i],
					'ancho' => $W1[$i],
					'texto' => $renglon['AsincronoTemporal']['texto_3'],
					'borde' => '',
					'align' => 'L',
					'fondo' => 0,
					'style' => '',
		...
		$PDF->linea[0] = array(
					'posx' => ($dias > 1 ? $L1[1] : $L1[0]),
					'ancho' => ($dias > 1 ? $W1[1] : $W1[0]),
					'texto' => $renglon['AsincronoTemporal']['texto_4'],
					'borde' => '',
					'align' => 'L',
					'fondo' => 0,
					'style' => '',
