...
?>
<h3>PLANILLA DE CAJA NRO.: <?php echo $planilla_numero?></h3>
<?php if($show_asincrono == 1):?>
	...
	echo $this->renderElement('show',array(
											...
											'accion' => '.cajabanco.banco_cuenta_saldos.view_planilla_caja.' . $banco_cuenta_saldo_id,
											'target' => '',
											'btn_label' => 'Ver Listado',
											'titulo' => "PLANILLA DE CAJA NRO.: " . $planilla_numero,
											'subtitulo' => 'FECHA DE CIERRE: ' . $util->armaFecha($fecha_cierre),
											'p1' => $BancoCuentaId,
											'p2' => $fecha_cierre,
											'p3' => $banco_cuenta_saldo_id
	));
...
<div class="areaDatoForm">
	...
	echo $controles->botonGenerico('/cajabanco/banco_listados/planilla_caja_salida/' . $asincrono_id . '/PDF/1','controles/pdf.png', null, array('target' => '_blank', 'id' => 'pdf'));
	?>
