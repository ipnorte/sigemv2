...
<div class="areaDatoForm">
	<h3>MODIFICAR DATOS CHEQUERA</h3>
	<table class="tbl_form">
		<tr>
			<td>CONCEPTO</td><td><?php echo $frm->input('concepto',array('size' => 60, 'maxlength' => 100))?></td>
		</tr>
		<tr>
			<td>SERIE</td><td><?php echo $frm->input('serie',array('size' => 2, 'maxlength' => 1, 'disabled' => 'disabled'))?></td>
		</tr>		
		<tr>
			<td>DESDE NUMERO</td><td><?php echo $frm->number('desde_numero',array('size' => 8, 'maxlength' => 8, 'disabled' => 'disabled'))?></td>
		</tr>
		<tr>
			<td>HASTA NUMERO</td><td><?php echo $frm->number('hasta_numero',array('size' => 8, 'maxlength' => 8, 'disabled' => 'disabled'))?></td>
		</tr>
		<tr>
			<td>PROXIMO A EMITIR</td><td><?php echo $frm->number('proximo_numero',array('size' => 8, 'maxlength' => 8, 'disabled' => 'disabled'))?></td>
		</tr>		
		<tr>
