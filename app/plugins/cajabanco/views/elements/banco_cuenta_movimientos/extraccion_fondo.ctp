...
<br />
DESTINATARIO: <strong><?php echo (empty($movimiento[0]['destinatario']) ? strtoupper(Configure::read('APLICACION.nombre_fantasia')) : $movimiento[0]['destinatario']) . " (CAJA)";?></strong>
...
<br />
	<table>
		...
		<tr>
			<td><?php echo $movimiento[0]['banco_cuenta']?></td>
