...
<?php echo $form->create(null,array('name'=>'formAddPersona','id'=>'formAddBeneficio','onsubmit' => "return validateForm()",'action' => 'add/'. $persona['Persona']['id']));?>
...
<div class="areaDatoForm">
	...
	<table class="tbl_form">
		<tr>
			<td>
				<?php //   echo $this->requestAction('/config/global_datos/combo/ORGANISMO/PersonaBeneficio.codigo_beneficio/MUTUCORG/0/0/'.$this->data['PersonaBeneficio']['codigo_beneficio'])?>
...
//																			'plugin'=>'config',
//																			'metodo' => "get_empresas/1",
//																			'model' => 'PersonaBeneficio.codigo_empresa1',
//																			'empty' => false,
//																			'label' => 'EMPRESA',
//																			'selected' => (isset($this->data['PersonaBeneficio']['codigo_empresa']) ? $this->data['PersonaBeneficio']['codigo_empresa'] : "")
//			));
			?>			
			</td>
			-->
