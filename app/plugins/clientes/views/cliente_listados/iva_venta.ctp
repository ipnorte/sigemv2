...
<?php
?>
<?php echo $frm->create(null,array('action' => 'iva_venta','id' => 'form_iva_venta'))?>
...
<div class="areaDatoForm">
	...
	<?php 
		echo $controles->botonGenerico('/clientes/cliente_listados/iva_venta_xls/' . $fecha_desde . '/' . $fecha_hasta . '/' . $tipo,'controles/ms_excel.png', null, array('id' => 'xls'));
		echo $controles->botonGenerico('/clientes/cliente_listados/iva_venta_pdf/' . $fecha_desde . '/' . $fecha_hasta . '/' . $tipo,'controles/pdf.png', null, array('target' => '_blank', 'id' => 'pdf'));
	?>
