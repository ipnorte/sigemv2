...
$PDF->Reset();
	...
	foreach ($saldos as $saldo):
		...
		$PDF->linea[1] = array(
			'posx' => $L0[1],
			'ancho' => $W0[1],
			'texto' => ($saldo['Cliente']['razon_social_resumida'] == "" ? $saldo['Cliente']['razon_social'] : $saldo['Cliente']['razon_social_resumida']),
			'borde' => 'LR',
			'align' => 'L',
			'fondo' => 0,
			'style' => '',
		...
		$PDF->linea[6] = array(
			'posx' => $L0[6],
			'ancho' => $W0[6],
			'texto' => number_format($saldo['0']['cobro'],2),
			'borde' => 'LR',
			'align' => 'R',
			'fondo' => 0,
			'style' => '',
