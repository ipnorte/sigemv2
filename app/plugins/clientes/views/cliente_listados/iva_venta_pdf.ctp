...
$PDF->linea[2] = array(
			'posx' => $L0[2],
			'ancho' => $W0[2],
			'texto' => $renglon['ClienteFactura']['razon_social'],
			'borde' => '',
			'align' => 'L',
			'fondo' => 0,
			'style' => '',
...
$PDF->linea[3] = array(
			'posx' => $L0[3],
			'ancho' => $W0[3],
			'texto' => $renglon['ClienteFactura']['cuit'],
			'borde' => '',
			'align' => 'L',
			'fondo' => 0,
			'style' => '',
...
$PDF->linea[4] = array(
			'posx' => $L0[4],
			'ancho' => $W0[4],
			'texto' => number_format($renglon['ClienteFactura']['importe_no_gravado'] * ($renglon['ClienteFactura']['tipo'] == 'NC' ? -1 : 1),2),
			'borde' => '',
			'align' => 'R',
			'fondo' => 0,
			'style' => '',
...
$PDF->linea[5] = array(
			'posx' => $L0[5],
			'ancho' => $W0[5],
			'texto' => number_format($renglon['ClienteFactura']['importe_gravado'] * ($renglon['ClienteFactura']['tipo'] == 'NC' ? -1 : 1),2),
			'borde' => '',
			'align' => 'R',
			'fondo' => 0,
			'style' => '',
...
$PDF->linea[6] = array(
			'posx' => $L0[6],
			'ancho' => $W0[6],
			'texto' => number_format($renglon['ClienteFactura']['importe_iva'] * ($renglon['ClienteFactura']['tipo'] == 'NC' ? -1 : 1),2),
			'borde' => '',
			'align' => 'R',
			'fondo' => 0,
			'style' => '',
...
$PDF->linea[7] = array(
			'posx' => $L0[7],
			'ancho' => $W0[7],
			'texto' => number_format($renglon['ClienteFactura']['percepcion'] * ($renglon['ClienteFactura']['tipo'] == 'NC' ? -1 : 1),2),
			'borde' => '',
			'align' => 'R',
			'fondo' => 0,
			'style' => '',
...
$PDF->linea[8] = array(
			'posx' => $L0[8],
			'ancho' => $W0[8],
			'texto' => number_format($renglon['ClienteFactura']['retencion'] * ($renglon['ClienteFactura']['tipo'] == 'NC' ? -1 : 1),2),
			'borde' => '',
			'align' => 'R',
			'fondo' => 0,
			'style' => '',
...
$PDF->linea[9] = array(
			'posx' => $L0[9],
			'ancho' => $W0[9],
			'texto' => number_format($renglon['ClienteFactura']['impuesto_interno'] * ($renglon['ClienteFactura']['tipo'] == 'NC' ? -1 : 1),2),
			'borde' => '',
			'align' => 'R',
			'fondo' => 0,
			'style' => '',
...
$PDF->linea[10] = array(
			'posx' => $L0[10],
			'ancho' => $W0[10],
			'texto' => number_format($renglon['ClienteFactura']['ingreso_bruto'] * ($renglon['ClienteFactura']['tipo'] == 'NC' ? -1 : 1),2),
			'borde' => '',
			'align' => 'R',
			'fondo' => 0,
			'style' => '',
...
$PDF->linea[11] = array(
			'posx' => $L0[11],
			'ancho' => $W0[11],
			'texto' => number_format($renglon['ClienteFactura']['otro_impuesto'] * ($renglon['ClienteFactura']['tipo'] == 'NC' ? -1 : 1),2),
			'borde' => '',
			'align' => 'R',
			'fondo' => 0,
			'style' => '',
