...
if($copias > 1) $PDF->titulo['titulo2'] = 'ORIGINAL';
...
for($k = 1; $k <= $copias; $k++):
	if($k == 2) $PDF->titulo['titulo2'] = 'DUPLICADO';
$PDF->AddPage();
$PDF->reset();
	...
	$PDF->linea[0] = array(
				'posx' => 5,
				'ancho' => 138,
				'texto' => utf8_decode('Señor/es: ' . $aRecibo['Recibo']['razon_social']),
				'borde' => 'LTR',
				'align' => 'L',
				'fondo' => 0,
				'style' => 'B',
	...
	$PDF->linea[0] = array(
				'posx' => 5,
				'ancho' => 138,
				'texto' => utf8_decode('Domicilio: ' . $aRecibo['Recibo']['domicilio']),
				'borde' => 'LBR',
				'align' => 'L',
				'fondo' => 0,
				'style' => 'B',
...
//		);
	...
	$PDF->linea[0] = array(
				'posx' => 5,
				'ancho' => 24,
				'texto' => utf8_decode($aRecibo['Recibo']['importe_letra']),
				'borde' => '',
				'align' => 'L',
				'fondo' => 0,
				'style' => '',
	...
	foreach($aRecibo['Recibo']['detalle'] as $liquidacion){
		...
		$PDF->linea[0] = array(
					'posx' => 5,
					'ancho' => 113,
					'texto' => substr(utf8_decode($liquidacion['concepto']),0,93). (strlen($liquidacion['concepto']) > 93 ? '...' : ''),
					'borde' => '',
					'align' => 'L',
					'fondo' => 0,
					'style' => '',
	...
	foreach($aRecibo['Recibo']['forma'] as $forma){
		if($forma['forma_cobro'] != 'EF'):
			$PDF->linea[0] = array(
						'posx' => 5,
						'ancho' => 113,
						'texto' => utf8_decode($forma['concepto']),
						'borde' => '',
						'align' => 'L',
						'fondo' => 0,
						'style' => '',
			...
			$PDF->linea[0] = array(
						'posx' => 5,
						'ancho' => 113,
						'texto' => utf8_decode($forma['concepto'] . ' ' . $forma['descripcion_cobro']),
						'borde' => '',
						'align' => 'L',
						'fondo' => 0,
						'style' => '',
		...
		if($forma['forma_cobro'] != 'EF'):
			$PDF->linea[0] = array(
						'posx' => 5,
						'ancho' => 113,
						'texto' => utf8_decode($forma['descripcion_cobro'] . ' - ' . $forma['numero_operacion']),
						'borde' => '',
						'align' => 'L',
						'fondo' => 0,
						'style' => '',
