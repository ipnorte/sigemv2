...
<div class="contenedor">
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
		...
		<tr id="filter">
			<td class="dato"></td>
			<td class="dato"><?php //echo $frm->input('Movimiento.comprobante', array('label'=>'','size'=>20,'maxlength'=>20)) ?></td>
			<td class="dato"><?php echo $frm->input('Movimiento.comentario', array('label'=>'','size'=>60,'maxlength'=>60, 'onkeyup' => 'filtra(this.value,2);')) ?></td>
			<td class="dato"><?php //echo $frm->input('Movimiento.fecha', array('label'=>'','size'=>10,'maxlength'=>10, 'onkeyup' => 'filtra(this.value,3);')) ?></td>
			<td class="dato"><?php //echo $frm->input('Movimiento.vencimiento', array('label'=>'','size'=>10,'maxlength'=>10, 'onkeyup' => 'filtra(this.value,4);')) ?></td>
			<td class="dato"><?php //echo $frm->input('Movimiento.importe_comprobante', array('label'=>'','size'=>10,'maxlength'=>10)) ?></td>
			<td class="dato"><?php //echo $frm->input('Movimiento.importe_vencimiento', array('label'=>'','size'=>10,'maxlength'=>10)) ?></td>
			<td class="dato"><?php //echo $frm->input('Movimiento.pagado', array('label'=>'','size'=>10,'maxlength'=>10)) ?></td>
			<td class="dato"><?php //echo $frm->input('Movimiento.saldo', array('label'=>'','size'=>10,'maxlength'=>10)) ?></td>
		</tr>
			...
			<?php
				...
				$nTotal = 0;
			  	foreach($facturaPendiente as $fPendiente):
			  		$i++;
			  		$linea = "TRL_" . $i;
			  		$param1 = ($fPendiente['orden_pago_id'] != 0 ? $fPendiente['orden_pago_id'] : $fPendiente['proveedor_factura_id']);
			  		$nTotal += $fPendiente['saldo']; 

		  		?>
		  		<tr id='LTR_<?php echo $i;?>'>
		  			<td class="dato">
		  			<?php //   echo $controles->btnCallJS("mostrarSubTabla('$i')", "", "controles/arrow_right.gif")?>
		  			...
		  			<?php //   echo $controles->ajaxLoader('spinner_'.$i,'')?>
		  			</td>
