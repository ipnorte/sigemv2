...
$PDF->Open();
$PDF->textoHeader = 'FECHA ORDEN: ' . $util->armaFecha($aOrdenDePago['OrdenPago']['fecha_pago']);
...
//		endif;	
	...
	$PDF->Imprimir_linea();
	//le puse color fondo para ver si es esto el error que muestra el log (no se imprime porque el attrib fondo = 0	
	$PDF->Ln(20);
	$PDF->linea[0] = array(
				'posx' => 17,
				'ancho' => 40,
