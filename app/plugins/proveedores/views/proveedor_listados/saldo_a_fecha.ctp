...
<div class="areaDatoForm">
	...
	<table class="tbl_form">
		...
		<tr>
			...
			<td><?php echo $frm->input('SaldoFecha.tipo',array('type'=>'select','options'=>array(3 => 'TODOS', 0 => 'PROVEEDOR', 1 => 'COMERCIO'), 'selected' => $tipo));?></td>
...
<div class="areaDatoForm">
	...
	<?php 
		echo $controles->botonGenerico('/proveedores/proveedor_listados/saldo_a_fecha_xls/' . $fecha_desde . '/' . $fecha_hasta . '/' . $tipo,'controles/ms_excel.png', null, array('id' => 'xls'));
		echo $controles->botonGenerico('/proveedores/proveedor_listados/saldo_a_fecha_pdf/' . $fecha_desde . '/' . $fecha_hasta . '/' . $tipo,'controles/pdf.png', null, array('target' => '_blank', 'id' => 'pdf'));
	?></p>
	
	<p>LISTADO DETALLADO
	
	<?php 
		echo $controles->botonGenerico('/proveedores/proveedor_listados/saldo_a_fecha_detalle_xls/' . $fecha_desde . '/' . $fecha_hasta . '/' . $tipo,'controles/ms_excel.png', null, array('id' => 'xls'));
		echo $controles->botonGenerico('/proveedores/proveedor_listados/saldo_a_fecha_detalle_pdf/' . $fecha_desde . '/' . $fecha_hasta . '/' . $tipo,'controles/pdf.png', null, array('target' => '_blank', 'id' => 'pdf'));
	?></p>
	...
	?>
		<tr>
			...
			<td align="center" style="font-size: small;">
				<?php 
				echo $controles->botonGenerico('/proveedores/proveedor_listados/cta_cte_fecha/' . $saldo['Proveedor']['id'] . '/' . $fecha_desde . '/' . $fecha_hasta . '/' . $saldo['0']['saldo_anterior'],'controles/HTML-globe.png', null, array('id' => 'html'));
				echo $controles->botonGenerico('/proveedores/proveedor_listados/cta_cte_fecha_xls/' . $saldo['Proveedor']['id'] . '/' . $fecha_desde . '/' . $fecha_hasta,'controles/ms_excel.png', null, array('id' => 'xls'));
				echo $controles->botonGenerico('/proveedores/proveedor_listados/cta_cte_fecha_pdf/' . $saldo['Proveedor']['id'] . '/' . $fecha_desde . '/' . $fecha_hasta,'controles/pdf.png', null, array('target' => '_blank', 'id' => 'pdf'));
				?>
			</td>
		</tr>
	<?php endforeach; ?>
