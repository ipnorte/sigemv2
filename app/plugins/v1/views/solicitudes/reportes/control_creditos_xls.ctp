...
$oPHPExcel->getActiveSheet()->setTitle('REPORTE_CONTROL');

$oPHPExcel->getActiveSheet()->setCellValue('A1',$proveedor);
$oPHPExcel->getActiveSheet()->setCellValue('A2',$periodo_corte);
$oPHPExcel->getActiveSheet()->setCellValue('A3',"[$cuotas_adeudadas] CUOTAS ADEUDADAS");
