<?php echo $this->renderElement('head',array('title' => 'PROCESAR ARCHIVO EXCEL DE REINTEGROS'))?>
<?php echo $this->renderElement('generador_diskette_bancos/menu',array('plugin' => 'config'))?>
<h3>PROCESA ARCHIVO EXCEL DE REINTEGROS</h3>
<div class="areaDatoForm">
    <?php echo $frm->create(null,array('action' => 'excel_reintegros','type' => 'file'))?>
	<table class="tbl_form">
        <tr>
            <td>ARCHIVO DE REINTEGROS</td>
            <td>
...
<table>
		...
		<tr>
			<th colspan="7">REGISTROS LEIDOS</th>
		</tr>
		<tr>
			<th>LINEA</th>
            <th>NRO SOCIO</th>
        ...
        <?php endforeach;?>
        <tr class="totales">
            <th colspan="5">IMPORTE TOTAL (STATUS = OK)</th>
