<?php echo $this->renderElement('head',array('title' => 'BARRIOS :: NUEVO BARRIO'))?>
...
<div class="areaDatoForm">
	...
	<div class='row'>
		...
		<?php echo $frm->input('Barrio.localidadAproxima',array('label'=>'Localidad (Aproximar por Nombre)','size'=>50,'maxlenght'=>100)); ?>
		...
		//<![CDATA[
			...
			document.getElementById("BarrioLocalidadAproxima").value = "";
			document.getElementById("BarrioLocalidadId").value = 0;				
