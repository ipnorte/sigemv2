<h3>NUEVA CONFIGURACION DE CHEQUES</h3>
...
<?php echo $frm->create(null,array('name'=>'formCnfImpresion','id'=>'formCnfImpresion', 'onsubmit' => ""));?>
				...
				<td>
					<div>
							<table id='diaVen'>
								...
								<tr>
									<td>Formato:</td>
									<td><?php echo $frm->input('CnfImpresion.DiaVenFor', array('type' => 'select','options' => array('0' => 'Texto: para indicar que aparezca (veinticinco)', '1' => 'd: Uno o dos dígitos para el día (8, 10, 25)', '2' => 'dd: Dos dígitos para el día (08, 10, 25)')));?></td>
								</tr>
							</table>
							...
							<table id='mesVen'>
								...
								<tr>
									<td>Formato:</td>
									<td><?php echo $frm->input('CnfImpresion.MesVenFor', array('type' => 'select','options' => array('0' => 'm: Uno o dos dígitos para el mes (8, 12)', '1' => 'mm: Dos dígitos para el mes (08, 12)', '2' => 'mmm: Mes abreviado (Ene, Feb, Mar)', '3' => 'mmmm: Mes completo (Enero, Febrero)')));?></td>
								</tr>
							</table>
							...
							<table id='anoVen'>
								...
								<tr>
									<td>Formato:</td>
									<td><?php echo $frm->input('CnfImpresion.AnoVenFor', array('type' => 'select','options' => array('0' => 'aa: 2 dígitos para el año (05, 06)', '1' => 'aaaa: 4 dígitos para el año (2005, 2006)')));?></td>
								</tr>
							</table>
							...
							<table id='fecVen'>
								...
								<tr>
									<td>Formato:</td>
									<td><?php echo $frm->input('CnfImpresion.FecVenFor', array('type' => 'select','options' => array('0' => '31/12/07', '1' => '31/12/2007', '2' => '31 de Diciembre de 07', '3' => '31 de Dic. de 07', '4' => '31 de Diciembre de 2007', '5' => '31 de Dic. de 2007')));?></td>
								</tr>
							</table>
							...
							<table id='diaEmi'>
								...
								<tr>
									<td>Formato:</td>
									<td><?php echo $frm->input('CnfImpresion.DiaEmiFor', array('type' => 'select','options' => array('0' => 'Texto: para indicar que aparezca (veinticinco)', '1' => 'd: Uno o dos dígitos para el día (8, 10, 25)', '2' => 'dd: Dos dígitos para el día (08, 10, 25)')));?></td>
								</tr>
							</table>
							...
							<table id='mesEmi'>
								...
								<tr>
									<td>Formato:</td>
									<td><?php echo $frm->input('CnfImpresion.MesEmiFor', array('type' => 'select','options' => array('0' => 'm: Uno o dos dígitos para el mes (8, 12)', '1' => 'mm: Dos dígitos para el mes (08, 12)', '2' => 'mmm: Mes abreviado (Ene, Feb, Mar)', '3' => 'mmmm: Mes completo (Enero, Febrero)')));?></td>
								</tr>
							</table>
							...
							<table id='anoEmi'>
								...
								<tr>
									<td>Formato:</td>
									<td><?php echo $frm->input('CnfImpresion.AnoEmiFor', array('type' => 'select','options' => array('0' => 'aa: 2 dígitos para el año (05, 06)', '1' => 'aaaa: 4 dígitos para el año (2005, 2006)')));?></td>
								</tr>
							</table>
							...
							<table id='fecEmi'>
								...
								<tr>
									<td>Formato:</td>
									<td><?php echo $frm->input('CnfImpresion.FecEmiFor', array('type' => 'select','options' => array('0' => '31/12/07', '1' => '31/12/2007', '2' => '31 de Diciembre de 07', '3' => '31 de Dic. de 07', '4' => '31 de Diciembre de 2007', '5' => '31 de Dic. de 2007')));?></td>
								</tr>
							</table>
				...
				<td>
					<table>
						...
						<tr>
							...
							<td><?php echo $frm->input('CnfImpresion.Talonario',array('type' => 'select','options' => array('0' => 'Papel continuo o cheques sueltos en horizontal', '1' => 'Hoja de cheques (varios cheques en una hoja)', '2' => 'Cheques sueltos en vertical')));?></td>
						</tr>
					</table>
				</td>
...
<?php echo $frm->hidden('CnfImpresion.DiaVen'); ?>
...
<?php echo $frm->hidden('CnfImpresion.DiaEmi'); ?>
...
<?php echo $frm->btnGuardarCancelar(array('URL' => '/config/configurar_impresiones/'))?> 
