<?php echo $this->renderElement('head',array('title' => 'BANCOS :: MODIFICAR BANCO'))?>
<?php echo $frm->create('Banco');?>
<div class="areaDatoForm">
 	<div class='row'>
 		<?php echo $frm->input('codigo',array('label'=>'CODIGO BCRA','size'=>5,'maxlength'=>5 , 'disabled' => 'disabled')) ?>
 		<?php echo $frm->input('nombre',array('label'=>'DENOMINACION','size'=>60,'maxlenght'=>100)) ?>
 	</div>
	<div class="row">
		<?php echo $frm->input('Banco.activo',array('label' => 'ACTIVO'))?>
	...
	<div class="row">
		<?php echo $frm->input('tipo_cta_sueldo',array('label' => 'CODIGO CUENTA SUELDO','size'=>3,'maxlength'=>2))?>
    ...
    <div class="row">
        <?php echo $frm->input('metodo_str_decode',array('label' => 'METODO DECODIFICACION','size'=>70,'maxlength'=>100))?>
    </div>    
    <div class="row">
