...
<div class="areaDatoForm">
    <h2>ASIENTO FINAL O DE CIERRE DEL EJERCICIO</h2>
<?php echo $form->create(null,array('name'=>'formAsiento','id'=>'formAsiento', 'action' => 'asiento_final_borrar/' . $asiento['Asiento']['co_ejercicio_id'] ));?>
...
<?php echo $frm->btnGuardarCancelar(array('TXT_GUARDAR' => 'BORRAR ASIENTO CIERRE','URL' => '/contabilidad/asientos/cierre_ejercicio/'.$asiento['Asiento']['co_ejercicio_id']))?>
