...
<h1>CUENTA :: <?php echo $cuentaMayor[0]['MutualAsientoRenglon']['cuenta']?></h1>
<h1>DESCRIPCION :: <?php echo $cuentaMayor[0]['MutualAsientoRenglon']['descripcion']?></h1>
...
<table align="center" width="100%">
	...
	<tr border="0">
		...
		<th style="border-top: 1px solid black;border-bottom: 1px solid black;border-right: 1px solid black;font-size: small;">SALDO</th>
	...
	?>
			...
			<tr>
				...
				<td align="right" style="border-right: 1px solid black;font-size: small;"><?php echo number_format($saldo,2)?></td>
				<td style="border-right: 1px solid black"><?php echo $mayor['MutualAsientoRenglon']['modulo']?></td>
			</tr>	
	<?php endforeach; ?>
	<tr>
		<td colspan="3" align="right" style="border-top: 1px solid black;border-bottom: 1px solid black;border-right: 1px solid black;font-size: small;">T O T A L</td>
		...
		<td align="right" style="border-top: 1px solid black;border-bottom: 1px solid black;border-right: 1px solid black;font-size: small;"><?php echo number_format($saldo,2)?></td>
	</tr>
</table>