...
(function ( $ ) {
    ...
    $.fn.localidadcomplete = function(options) {
                ...
                xhr = $.ajax({
                    ...
                    success: function( json ) {
                        ...
                        $.each( json, function(i, j) {
                            results += '<a href="#" class="list-group-item" data-id="'+j.id+'" data-label="' + j.label + '" data-codigo-postal="' + j.cp + '" data-localidad="' + j.localidad + '" >' + j.label + '</a>'
                        });
        ...
        function selectResult(){
            ...
            settings.fieldCp.val($(this).data('codigoPostal'));
            settings.fieldLocalidadNombre.val($(this).data('localidad'));
