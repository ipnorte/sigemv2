...
BEGIN
	...
	SELECT trim(concepto_3) into vTIPOORDEN from global_datos where id = vPRODUCTO COLLATE utf8_general_ci;	
	start transaction;
	...
	WHERE uuid_identificador = vUUID  COLLATE utf8_general_ci AND tipo = 2;
	...
	WHERE uuid_identificador = vUUID COLLATE utf8_general_ci AND tipo = 1;	
	...
	WHERE uuid_identificador = vUUID COLLATE utf8_general_ci AND tipo = 3;	
	    
    
	DELETE FROM mutual_producto_solicitud_preproceso WHERE uuid_identificador = vUUID COLLATE utf8_general_ci;		
