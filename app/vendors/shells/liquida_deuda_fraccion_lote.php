 ...
 *	/usr/bin/php5 /home/adrian/trabajo/www/sigem/cake/console/cake.php liquida_deuda_fraccion_lote 24271 -app /home/adrian/trabajo/www/sigem/app/
 *	/opt/lampp/bin/php-5.2.8 /home/adrian/Desarrollo/www/sigem/cake/console/cake.php liquida_deuda_fraccion_lote 157 -app /home/adrian/Desarrollo/www/sigem/app/
 *	/usr/bin/php5 /var/www/sigem/cake/console/cake.php liquida_deuda_fraccion 1 -app /var/www/sigem/app/
 *	/usr/bin/php5 /var/www/virtual/mutual22septiembre.com.ar/htdocs/sigem/cake/console/cake.php liquida_deuda_fraccion_lote 33 -app /var/www/virtual/mutual22septiembre.com.ar/htdocs/sigem/app/
...
class LiquidaDeudaFraccionLoteShell extends Shell{
...
//        $DISCRIMINA_PERMANENTES = isset($this->args[12]) ? TRUE : FALSE;
//        $CONSOLIDADO            = isset($this->args[13]) ? TRUE : FALSE;
//        
//        $CONSOLIDADO = TRUE;
        ...
        if(isset($INI_FILE['general']['banco_nacion_debito_periodo']) && $INI_FILE['general']['banco_nacion_debito_periodo'] != ""){
            $CONTROL_NACION = 1;
...
//                $oSocio->query("CALL SP_LIQUIDA_DEUDA_CBU($socio_id,'$periodo','$organismo',".($pre_imputacion == 1 ? 'TRUE':'FALSE').")");
		$this->LiquidacionSocio->auditable = FALSE;
                ...
                $ERROR = $this->LiquidacionSocio->liquidar($socio_id,$periodo,$organismo,$this->liquidacionID,true,$pre_imputacion,$liqSiTieneDeuda,$CONTROL_NACION,$BANCO_CONTROL,$DISCRIMINA_PERMANENTES,$tipoFiltro,$CONSOLIDADO);
