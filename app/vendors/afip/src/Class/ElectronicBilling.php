...
class ElectronicBilling extends AfipWebService {
	...
	**/
	...
	/**
	 * Change date from AFIP used format (yyyymmddHHiiss) to yyyy-mm-dd hh:ii:ss
	 *
	 * @since 0.7
	 *
	 * @param string|int date to format
	...
	**/
	public function FormatDateL($date)
	{
		return date_format(DateTime::CreateFromFormat('YmdHis', $date.''), 'Y-m-d H:i:s');
	}
