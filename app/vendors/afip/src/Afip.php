...
class Afip {
	...
	function __construct($options)
	{
		...
		if (!isset($options['res_folder'])) {
			$this->RES_FOLDER = __DIR__.DS.'Afip_res'.DS;
		} else {
			$this->RES_FOLDER = $options['res_folder'];
		}

		if (!isset($options['ta_folder'])) {
			$this->TA_FOLDER = __DIR__.DS.'Afip_res'.DS;
		} else {
		...
		$this->WSAA_WSDL 	= __DIR__.DS.'Afip_res'.DS.'wsaa.wsdl';
...
class AfipWebService
{
	...
	function __construct($afip)
	{
		...
		if ($this->afip->options['production'] === TRUE) {
			$this->WSDL = __DIR__.DS.'Afip_res'.DS.$this->WSDL;
		} else {
			$this->WSDL = __DIR__.DS.'Afip_res'.DS.$this->WSDL_TEST;
